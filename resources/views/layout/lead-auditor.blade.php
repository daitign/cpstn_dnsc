<ul class="nav flex-column shadow d-flex sidebar mobile-hid">
    ...
    <li class="nav-item"><a class="nav-link text-start py-1 px-0 {{ request()->routeIs('lead-auditor.dashboard') ? 'active' : '' }}" href="{{ route('lead-auditor.dashboard') }}"><i class="fas fa-tachometer-alt mx-3"></i><span class="text-nowrap mx-2">Dashboard</span></a></li>
    ...
    <li class="nav-item"><a class="nav-link text-start py-1 px-0 {{ request()->routeIs('lead-auditor.audit.index') ? 'active' : '' }}" href="{{ route('lead-auditor.audit.index') }}"><i class="fas fa-book mx-3"></i><span class="text-nowrap mx-2">Audit Plan</span></a></li>
