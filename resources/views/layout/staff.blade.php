...
<ul class="nav flex-column shadow d-flex sidebar mobile-hid">
    ...
    <li class="nav-item"><a class="nav-link text-start py-1 px-0 {{ request()->is('staff.manual.index') ? 'active' : '' }}" href="{{ route('staff.manual.index') }}"><i class="fas fa-book mx-3"></i><span class="text-nowrap mx-2">Manuals</span></a></li>
