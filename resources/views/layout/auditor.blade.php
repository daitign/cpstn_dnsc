<ul class="nav flex-column shadow d-flex sidebar mobile-hid">
    ...
    <li class="nav-item"><a class="nav-link text-start py-1 px-0 {{ request()->routeIs('templates') ? 'active' : '' }}" href="{{ route('templates') }}"><i class="fas fa-book mx-3"></i><span class="text-nowrap mx-2">Templates</span></a></li>
