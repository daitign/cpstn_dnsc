<ul class="nav flex-column shadow d-flex sidebar mobile-hid">
    ...
    <li class="nav-item"><a class="nav-link text-start py-1 px-0 {{ request()->is('auditor/audit-evidence*') ? 'active' : '' }}" href="{{ route('auditor.audit.evidence.index') }}"><i class="fas fa-receipt mx-3"></i><span class="text-nowrap mx-2">Audit Evidences</span></a></li>
